          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 font-montserrat">hello@lilianadegbola.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <SafeIcon icon={FiPhone} className="w-5 h-5 text-gold-400" />
                <span className="text-gray-300 font-montserrat">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <SafeIcon icon={FiMapPin} className="w-5 h-5 text-gold-400" />
                <span className="text-gray-300 font-montserrat">New York, NY</span>
              </div>
            </div>
          </div>
        </div>
