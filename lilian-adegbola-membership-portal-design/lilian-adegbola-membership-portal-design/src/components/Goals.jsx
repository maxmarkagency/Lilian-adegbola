  ...
  const [goals, setGoals] = useState([
    {
      ...
      description: 'Finish all 24 lessons and pass the final assessment',
      category: 'learning',
      priority: 'high',
      progress: 75,
      ...
      status: 'in-progress',
      milestones: [
        { id: 1, title: 'Complete Module 1-4', completed: true },
        { id: 2, title: 'Complete Module 5-8', completed: true },
        { id: 3, title: 'Complete Module 9-12', completed: false },
    ...
    },
    {
      ...
      description: 'Create and deploy a professional website showcasing my work',
      category: 'career',
      priority: 'high',
      progress: 45,
      ...
      milestones: [
        ...
        { id: 2, title: 'Develop homepage', completed: false },
        { id: 3, title: 'Create portfolio section', completed: false },
        { id: 4, title: 'Deploy and test', completed: false }
      ]
    },
    {
      id: 3,
      title: 'Read 12 Business Books',
      description: 'Expand knowledge through strategic reading',
      category: 'personal',
      priority: 'medium',
      progress: 33,
      ...
      status: 'in-progress',
      milestones: [
        { id: 1, title: 'Read 3 books (Q1)', completed: true },
        { id: 2, title: 'Read 3 books (Q2)', completed: false },
        { id: 3, title: 'Read 3 books (Q3)', completed: false },
        { id: 4, title: 'Read 3 books (Q4)', completed: false }
      ]
    }
  ]);
