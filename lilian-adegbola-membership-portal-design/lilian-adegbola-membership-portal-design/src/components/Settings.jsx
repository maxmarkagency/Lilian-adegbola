              ...
              {activeTab === 'billing' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gold-50 border border-gold-200 rounded-lg p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-playfair font-bold text-navy-800">Premium Membership</h3>
                        <p className="text-gray-600 font-montserrat">Full access to all courses and resources</p>
                        <p className="text-sm text-gray-500 font-montserrat mt-1">Next billing: March 15, 2024</p>
                      </div>
                      <div className="text-right">
                        <div className="text-2xl font-playfair font-bold text-gold-600">$29.99</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="w-full text-left p-4 border border-red-200 rounded-lg hover:bg-red-50 transition-colors text-red-600">
                      ...
                      <div className="text-sm font-montserrat">End your membership</div>
                    </button>
                  </div>
                </div>
              )}
