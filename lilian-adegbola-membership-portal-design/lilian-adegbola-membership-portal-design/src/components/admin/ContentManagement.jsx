...
const ContentManagement = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      description: 'Develop exceptional leadership skills',
      status: 'draft',
      category: 'Leadership',
      price: 129.99,
      students: 1834,
  ...
  const renderCourses = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { title: 'Total Courses', value: '24', icon: FiBook, color: 'blue' },
          { title: 'Published', value: '21', icon: FiPlay, color: 'emerald' },
          { title: 'Total Students', value: '5,432', icon: FiUsers, color: 'purple' },
          { title: 'Avg Rating', value: '4.8', icon: FiStar, color: 'gold' }
        ].map((stat, index) => (
  ...
  const renderResources = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { title: 'Total Resources', value: '156', icon: FiFileText, color: 'blue' },
          { title: 'Downloads', value: '12.5K', icon: FiDownload, color: 'emerald' },
          { title: 'Categories', value: '8', icon: FiFilter, color: 'purple' },
          { title: 'Storage Used', value: '2.4GB', icon: FiUpload, color: 'orange' }
        ].map((stat, index) => (
          <div key={index} className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <div className={`w-12 h-12 bg-${stat.color}-500 rounded-lg flex items-center justify-center`}>
          ...
          <div className="flex space-x-6 border-b border-gray-200">
            {[
              ...
              <button
                ...
                className={`flex items-center space-x-2 pb-4 px-2 font-montserrat font-medium transition-all duration-200 ${
                  activeTab === tab.id
