...
const SupportCenter = () => {
  ...
  const tickets = [
    {
      id: 'TKT-2024-001',
      subject: 'Unable to access premium course content',
      customer: {
        name: 'Sarah Johnson',
      ...
      lastUpdate: '2024-02-20T14:45:00Z',
      assignedTo: 'John Smith',
      description: 'I purchased the Digital Marketing Mastery course but cannot access the video content. Getting error 403 when trying to play videos.',
      responses: 2
    },
    {
      id: 'TKT-2024-002',
      ...
      description: 'My subscription was charged twice this month. Need refund for duplicate charge.',
      responses: 1
    },
    {
      id: 'TKT-2024-003',
      ...
      lastUpdate: '2024-02-19T10:30:00Z',
      assignedTo: 'Alex Wilson',
      description: 'Completed Leadership Excellence course and need certificate for my employer.',
      responses: 3
    }
  ];
